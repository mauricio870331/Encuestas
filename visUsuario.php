...
for ($k = 0; $k < count($arrayPreguntas); $k++) {// $k -> Array Preguntas
    for ($l = 0; $l < count($arrayRespuestas); $l++) {// $l -> Array Respuestas
...
<html>
    <head>
        ...
        <title>Aplicativo Encuestas</title>        
            ...
            <div class="content">           
                ...
                <section class="content">
                    <div class="box" style = "width: 60%;margin-left: 20%;">                       
                        <div class="box-body">
                            <form role="form" id="form_encuesta" style="border-color: graytext !important">
                                <div class="box-body" >
